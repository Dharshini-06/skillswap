...
const Messages = () => {
    ...
    useEffect(() => {
        const fetchUserData = async () => {
            ...
            try {
                ...
                const res = await axios.get(`https://://skillswap-ekvn.onrender.com/api/profile/${urlUserId}`);
                ...
                if (!swapId) {
                    const chatRes = await axios.get('https://://skillswap-ekvn.onrender.com/api/user', {
                ...
                if (swapId) {
                    const swapRes = await axios.get(`https://://skillswap-ekvn.onrender.com/api/swap/${swapId}`, {
                        headers: { 'x-user-id': userId }
                    });
    ...
    const handleSendInvite = async () => {
        try {
            const res = await axios.post("https://://skillswap-ekvn.onrender.com/api/session/send-invite", {
