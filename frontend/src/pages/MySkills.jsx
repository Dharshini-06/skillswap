...
const MySkills = () => {
    ...
    const fetchSkills = useCallback(async () => {
        ...
        setLoading(true);
        try {
            const response = await fetch(`http://https://skillswap-ekvn.onrender.com/api/users/${userId}/skills`);
    ...
    const fetchDashboardData = useCallback(async () => {
        if (!userId) return;
        try {
            const res = await fetch(`http://https://skillswap-ekvn.onrender.com/api/dashboard`, {
    ...
    const fetchMatches = useCallback(async () => {
        if (!userId) return;
        try {
            const res = await fetch(`http://https://skillswap-ekvn.onrender.com/api/users/matches`, {
                headers: { 'x-user-id': userId }
            });
            const data = await res.json();
    ...
    const handleSavePrefsOnly = async () => {
        try {
            setLoading(true);
            const response = await fetch(`http://https://skillswap-ekvn.onrender.com/api/users/${userId}/preferences`, {
                method: 'PUT',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
